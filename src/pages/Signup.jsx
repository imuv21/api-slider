            ...
            <div className="signupcont">
                <div className='flexcol cover'>
                    ...
                    <div className="flexcol gap">
                        ...
                        <input type='password' className="box flex" placeholder='Enter your password' value={password} onChange={(e) => setPassword(e.target.value)} />
                        <input type='password' className="box flex" placeholder='Confirm password' value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} />
                        ...
                        <Link className="heading2" style={{ color: 'var(--btnClr)' }} to='/'>Already have an account? Click here</Link>
                    </div>
